...
public class CommonController {
    ...
    public CommonController(RoleService roleService, RoleMenuRelationService roleMenuRelationService, MenuService menuService) {
    ...
    public ResponseDto<List<RoleMenuDto>> roleMenus(Authentication authentication) {
        ...
        List<RoleMenuRelation> relations = roleMenuRelationService.getAll(adminDetails.getRoleId(), MenuType.dir, MenuType.menu);
        Map<Long, RoleMenuDto> roleMenuMap = relations.stream().collect(Collectors.toMap(RoleMenuRelation::getMenuId, relation -> new RoleMenuDto(relation.getMenu())));
